...
CREATE TYPE "public"."job_status" AS ENUM('DRAFT', 'ACTIVE', 'UNDER_REVIEW', 'SHORTLIST_READY', 'CLOSED');--> statement-breakpoint
...
ALTER TABLE "question_bank" ADD CONSTRAINT "question_bank_source_job_id_jobs_id_fk" FOREIGN KEY ("source_job_id") REFERENCES "public"."jobs"("id") ON DELETE set null ON UPDATE no action;